...
namespace CoreLogic.Planners
{
    public class EmailPlanner
    {
    ...
    )
        {
            ...
            var result = await kernel.InvokePromptAsync($"I'm going to write an email to {recipients} about {topic} on behalf of a user\r. Before I do that, can you succinctly recommend the top 3 steps I should take in a numbered list?\r I want to make sure I don't forget anything that would help my user's email sound more professional.",
            new() {
            { "topic", topic },
